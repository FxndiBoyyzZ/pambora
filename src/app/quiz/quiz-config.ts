...
export const quizSteps: QuizStep[] = [
    {
        type: 'video',
        content: {
            videoUrl: 'https://player.vimeo.com/video/1116746550?autoplay=1&title=0&byline=0&portrait=0&controls=0&dnt=1&app_id=123456',
            backgroundUrl: '/fundo1.png',
            duration: 55, // Duração em segundos
        }
    },
    {
        type: 'form',
    ...
    },
    {
        type: 'video',
        content: {
            videoUrl: 'https://player.vimeo.com/video/1116746276?autoplay=1&title=0&byline=0&portrait=0&controls=0&dnt=1&app_id=123456',
            backgroundUrl: '/fundo1.png',
            duration: 16, // Duração em segundos
        }
    },
];
